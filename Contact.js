    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{marginTop:'3%',marginHorizontal:'5%'}}>
                ...
                <TextInput keyboardType="numeric" style={{borderBottomColor:errorNumTel!='' & errorNumTel != 'none' ? 'red' : 'grey',borderBottomWidth:errorNumTel!='' & errorNumTel != 'none' ? 1 : 0.5}} onChangeText={(text) => checkNumTel(text)}/>
            </View>
